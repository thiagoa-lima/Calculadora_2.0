...
btn_04 = Button(janela, command=percentual, text="%", font="Abadi 20 bold", bg=verde, fg="#000066", relief="groove", width=4, height=1)
btn_04.place(x=400, y=248)
...
btn_17 = Button(janela, command=lambda: operadores_matematicos(" + "), text="+", font="Abadi 20 bold", bg=cinza, fg="#000066", relief="groove", width=4, height=1)
btn_17.place(x=314, y=312)
btn_18 = Button(janela, command=resultado, text="=", font="Abadi 20 bold", bg=amarelo, fg="#000066", relief="groove", width=4, height=1)
btn_18.place(x=400, y=312)
